...
console.log(
  "1. Umur dalam Number:",
  ageInNumber,
  ", dan tipe data dari variable tersebut adalah:",
  ageDataType
);
...
console.log("Pembagian:", calculator("divide", num3, num4));
console.log("Pangkat:", calculator("power", base, exponent));
